...
public class ChampionTest {
    ...
    public void testForRelatedString() {
        ...
        assertThat(sampleString1, allOf(notNullValue(), containsString(sampleString1)));
        ...
        assertThat(sampleString2, startsWith(startString));
    }

    //부동소수점 범위 closeTo 테스트
    @Test
    public void testForFloatingPoint() {
        assertThat(4.52, closeTo(4, 0.53));
    }
    ...
    public void shouldSupportChampionIsTaric() {
        ...
        assertThat(supportChamp.getPosition(), equalTo("바텀"));
    }
    ...
    public void shouldTopChampionIsDarius() {
        ...
        assertTrue(filterChampion.get().getName().equals("다리우스"));
        assertTrue(filterChampion.get().getPosition().equals("탑"));
        System.out.print("champ :: "+filterChampion);
    }
